...
VALUES
(2, 1, 'banner1.jpg', 'Rock Concert', 'Live in City', 'Best rock concert ever', 'ONLINE', 'City Hall', NOW() + INTERVAL '5 days', NOW() + INTERVAL '6 days', NOW() + INTERVAL '4 days', 100, false, 50.00, true, NOW(), NOW()),
(2, 2, 'banner2.jpg', 'Painting Workshop', 'Learn to paint', 'Workshop for beginners', 'OFFLINE', 'Art Center', NOW() + INTERVAL '10 days', NOW() + INTERVAL '10 days', NOW() + INTERVAL '8 days', 30, true, 0.00, true, NOW(), NOW()),
(6, 3, 'banner3.jpg', 'Tech Meetup', 'Networking Night', 'Meet tech enthusiasts', 'ONLINE', 'Tech Hub', NOW() + INTERVAL '7 days', NOW() + INTERVAL '7 days', NOW() + INTERVAL '5 days', 50, true, 0.00, true, NOW(), NOW()),
(6, 4, 'banner4.jpg', 'Business Seminar', 'Grow your Startup', 'Seminar with industry leaders', 'OFFLINE', 'Convention Center', NOW() + INTERVAL '12 days', NOW() + INTERVAL '12 days', NOW() + INTERVAL '10 days', 80, false, 20.00, true, NOW(), NOW()),
(2, 5, 'banner5.jpg', 'Webinar on AI', 'Learn AI', 'Online webinar', 'ONLINE', 'Zoom', NOW() + INTERVAL '3 days', NOW() + INTERVAL '3 days', NOW() + INTERVAL '2 days', 200, true, 0.00, true, NOW(), NOW()),
(2, 1, 'banner6.jpg', 'Jazz Night', 'Smooth Jazz', 'Evening of jazz music', 'OFFLINE', 'Jazz Club', NOW() + INTERVAL '8 days', NOW() + INTERVAL '8 days', NOW() + INTERVAL '7 days', 60, false, 35.00, true, NOW(), NOW()),
(6, 2, 'banner7.jpg', 'Cooking Workshop', 'Culinary Skills', 'Learn new recipes', 'OFFLINE', 'Culinary Center', NOW() + INTERVAL '9 days', NOW() + INTERVAL '9 days', NOW() + INTERVAL '8 days', 40, false, 15.00, true, NOW(), NOW()),
(2, 3, 'banner8.jpg', 'Tech Talk', 'Latest in Tech', 'Discussion with experts', 'ONLINE', 'Tech Hub', NOW() + INTERVAL '11 days', NOW() + INTERVAL '11 days', NOW() + INTERVAL '9 days', 70, true, 0.00, true, NOW(), NOW()),
(6, 4, 'banner9.jpg', 'Startup Seminar', 'Funding & Growth', 'Seminar for entrepreneurs', 'OFFLINE', 'Convention Center', NOW() + INTERVAL '15 days', NOW() + INTERVAL '15 days', NOW() + INTERVAL '13 days', 50, false, 25.00, true, NOW(), NOW()),
(2, 5, 'banner10.jpg', 'AI Webinar Part 2', 'Deep Learning', 'Advanced webinar', 'ONLINE', 'Zoom', NOW() + INTERVAL '18 days', NOW() + INTERVAL '18 days', NOW() + INTERVAL '16 days', 150, true, 0.00, true, NOW(), NOW());
...
('TICKET003',2,1,NOW(),1,0.00,0.00,'RESERVED'),
('TICKET004',3,4,NOW(),3,0.00,0.00,'RESERVED'),
('TICKET005',4,5,NOW(),1,20.00,20.00,'PAID'),
('TICKET006',5,6,NOW(),1,0.00,0.00,'RESERVED'),
...
(5,5,20.00,'TXN124','COMPLETED',NOW(),NOW()),
(7,7,70.00,'TXN125','COMPLETED',NOW(),NOW()),
